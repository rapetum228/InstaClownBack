    ...
    public partial class chat : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageAttaches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageAttaches_Attaches_Id",
                        column: x => x.Id,
                        principalTable: "Attaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageAttaches_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageAttaches_MessageId",
                table: "MessageAttaches",
                column: "MessageId");
